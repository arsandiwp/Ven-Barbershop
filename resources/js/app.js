...
Vue.mixin({
  ...
  methods: {
    ...
    titleCase(kebab) {
      ...
      return interim.toLowerCase().replace(/\b\w/g, (s) => s.toUpperCase());
    },
    ...
    addNotification(text, options = {}) {
      ...
      setTimeout(() => {
        ...
        app.snackbar.buttonText = options.buttonText ? options.buttonText : "";
        ...
        .then((response) => {
          ...
          if (response.status == 200) {
            if (!!response.data.data && response.data.data.length > 0) {
              ...
              localStorage.adminLogin = JSON.stringify(app.adminLogin);
              app.roles = app.adminLogin.roles;
              localStorage.is_admin =
                app.adminLogin.role_id == 2 || app.adminLogin.role_id == 1
                  ? true
                  : false;
            } else {
