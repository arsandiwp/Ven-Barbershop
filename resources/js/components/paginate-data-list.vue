                ...
                <v-container>
                    ...
                    >
                        ...
                        <template v-slot:item.status="{ item }">
                            <label
                                :class="{
                                    'error--text': item.status == 'Inactive',
                                    'success--text': item.status == 'Active',
                                    'warning--text': item.status == 'Pending',
                                    'indigo--text': item.status == 'Published',
                        ...
                        <template v-slot:item.actions="{ item }">
                            <v-layout row wrap>
                                ...
                                >
                                    <template
                                        v-for="(btn, idx) in list.actions"
                                    >
                                        <v-tooltip
                                            bottom
                                            v-if="
                                                btn.fx &&
                                                checkRule(btn.rules, item)
                                            "
                                            :key="'action_btn-' + idx"
                                        >
                                            <template
...
export default {
    ...
    methods: {
        ...
        readDataFromAPI() {
            ...
            if (
                this.list.selectRegion &&
                this.list.selectRegion != "All Regions"
            ) {
