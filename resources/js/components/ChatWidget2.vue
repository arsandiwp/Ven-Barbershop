<template>
    <div class="chat-widget">
        <!-- The dialog is now placed more like a widget, aligned to the bottom-right -->
        <v-dialog
            v-model="isOpen"
            width="400"
            persistent
        ...
        >
            ...
            <v-card class="chat-container">
                ...
                <!-- <v-expand-transition>
                    <div v-if="showModelSelect" class="model-select-container">
                        <v-select
    ...
    methods: {
        async fetchAvailableModels() {
            try {
                ...
                const response = await axios.get(this.API + "/models");
        ...
        async sendToAPI(message) {
            try {
                const response = await axios.post(this.API + "/chatbot", {
                    message,
