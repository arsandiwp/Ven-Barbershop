            ...
            >
                <v-container fluid id="container-box-main-login">
                    <v-container fluid id="container-header-login">
                        ...
                        <p>Get your Template Project account now!</p>
                    </v-container>
                    <v-form
                        ...
                        <v-container fluid id="container-input-area-login">
                            <v-container class="container-text-field-login">
                                ...
                                <v-text-field
                                    ...
                                    @input="
                                        checkMaxLength(customer.name, 'name')
                                    "
                                    required
                                ></v-text-field>
                            </v-container>
                            <v-container class="container-text-field-login">
                                <label for="register-email" class="text-bolder"
                                    >Email*</label
                                >
                                <v-text-field
                                    id="register-email"
                                    ...
                                    @input="
                                        checkMaxLength(customer.email, 'email')
                                    "
                                    required
                            ...
                            <v-container class="container-text-field-login">
                                <label
                                    for="register-password-validation"
                                    class="text-bolder"
    ...
    data() {
        return {
            ...
            password_validation: [
                (v) => !!v || "Field is required",
                (v) =>
                    v == this.customer.password || "Incorrect re-type password",
            ],
            fieldMaxLengths: {
                name: 50,
                email: 60,
                ...
                axios
                    ...
                    .catch((error) => {
                        ...
                        if (responseErr.status == 422) {
                            ...
                            this.alert(
                                "Registration Failed (Error Code : 422)",
                                dataError,
                                { color: "#d9534f" }
                            );
                            return;
