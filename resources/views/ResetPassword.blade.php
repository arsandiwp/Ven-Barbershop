...
<head>
    ...
    <title>New email template 2019-10-18</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                        ...
                        <tr style="border-collapse:collapse;">
                            <td style="padding:0;Margin:0;background-color:#FAFAFA;" bgcolor="#fafafa" align="center">
                                <table class="es-content-body"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;"><img
                                                                        class="adapt-img"
                                                                        src="https://res.cloudinary.com/dtna3fs09/image/upload/v1739254416/vbnhldzacvkv67akujkv.png"
                                                                        alt
                                    ...
                                    <tr style="border-collapse:collapse;">
                                        <td style="Margin:0;padding-top:10px;padding-bottom:20px;padding-left:20px;padding-right:20px;background-color:transparent;background-position:left top;"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        If you didn't make this request, just ignore
                                                                        this email. Otherwise, please click the button
